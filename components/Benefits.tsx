...
function Benefits() {
  return (
    <div id='about' className='w-full px-6 lg:px-14 py-5 my-8'>
       <div className='flex flex-col-reverse lg:flex-row items-center justify-between py-5 my-7 px-3'>
        ...
        <h1 className='text-3xl mb-3 lg:mb-0 lg:text-6xl'>Benefits Provided By <br/> Our Service</h1>
       </div>

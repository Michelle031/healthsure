...
function Hero() {
  ...
  return (
    <div id='home' style={{background: `linear-gradient(to right, rgba(0,0,0,0.8), rgba(0,0,0,0.4)),url(/images/img${current}.png)`}} className="hero w-full h-screen relative top-0 left-0 flex flex-col text-white justify-center px-14 space-y-4 lg:space-y-3 leading-loose text-center lg:text-left">
